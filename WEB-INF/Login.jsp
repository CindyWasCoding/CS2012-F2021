...
<head>
<meta charset="UTF-8">
<title>SushiMartini - Login</title>
<link rel="stylesheet"
	...
	<div class="container">
		...
		<div class="wrapper">
			<span class="appName">SushiMartini</span> <span class="mt-n3"
				style="font-size: 12px;">Login</span>
			<!-- login form with 'post' method that sends data to doPost in Login.java file. -->
			<form class="loginForm" action='Login' method='post'>
				<input id="email" name='email' type="email"
					placeholder="Example@gmail.com"> <input id="password"
					name='password' type="password" placeholder="Password">
				<button class="signin bg-info" type="submit">Start Order</button>
			</form>
			<!-- a hyperlink to Register page -->
			<span style="font-size: 10px;">Do not have an account? <a
